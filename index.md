	 ...
	 <!-- Indicators -->
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="img/about_gbenga.jpg" alt="Los Angeles">
		    ...
		    <div class="carousel-item">
		      <img src="img/about_gbenga.jpg" alt="Chicago">
		      <div class="carousel-caption">
		    <h3>Los Angeles</h3>
		    <p>We had such a great time in LA!</p>
		  	</div>
		    ...
		    <div class="carousel-item">
		      <img src="img/about_gbenga.jpg" alt="New York">
		      <div class="carousel-caption">
		    <h3>Los Angeles</h3>
		    <p>We had such a great time in LA!</p>
		  	</div>
		...
		<div class="col-md-12 col-lg-12">
			<div class="container border bg-light p-4 my-4 rounded">
				 <form action="#" class="was-validated">
		    		...
		    		<!-- Codeblock for custom file upload and referencing file name-->
		    		<div class="custom-file">
					    <input type="file" class="custom-file-input" id="customFile">
					    <label class="custom-file-label" for="customFile">Browse file</label><pre></pre>
					  </div>
				    ...
				    <label class="custom-control-label text-primary" for="customCheck">Check this custom checkbox</label>
				  </div>
